...
<div class="max-w-[720px] mx-auto py-8">
  ...
  <form action="{{ route('stok.store') }}" method="POST">
    ...
    <div class="mb-4">
      ...
      <input type="number" name="jml_masuk" id="jml_masuk" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600" required>
    </div>
    ...
    <div class="mb-4">
      ...
      <input type="number" name="total_barang" id="total_barang" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600" required>
    </div>
